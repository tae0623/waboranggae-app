...
const START_TYPES: StartLocationType[] = ['station', 'terminal', 'lodging'];
  ...
  return (
    <View style={styles.card}>
      ...
      <View style={styles.wrap}>
        ...
        />
        <Chip
          active={value.wantsLuggageStorage}
          label="짐 보관 필요"
          onPress={() => patch({ wantsLuggageStorage: !value.wantsLuggageStorage })}
        />
      </View>
