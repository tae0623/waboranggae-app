...
const serviceKey = process.env.TOUR_API_KEY || process.env.DATA_GO_KR_KEY
  || localEnv.TOUR_API_KEY || localEnv.DATA_GO_KR_KEY;
...
if (!serviceKey) {
  throw new Error('TOUR_API_KEY 또는 DATA_GO_KR_KEY가 없습니다. .env에 발급 키를 넣어주세요.');
}
