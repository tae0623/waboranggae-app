...
export function tourItemsToCourses(items: TourApiItem[], preferences: TravelPreferences) {
...
export async function fetchTourApiCourses(preferences: TravelPreferences): Promise<Course[]> {
